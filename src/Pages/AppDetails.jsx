...
const AppDetails = () => {
    ...
    if (error || !filterData) {
        return <div className="text-red-500 text-center mt-10">App not found or error loading data.</div>;
    }
                        ...
                        <div className='container mx-auto px-10'>
                            <div className='flex gap-10 mt-15 mb-9'>
                                ...
                                <div className='space-y-3 flex-1'>
                                    ...
                                    <div>
                                        <button className='btn text-white bg-[#00d390]'>Install Now ({filterData.size} MB)</button>
                                    </div>
                                </div>
